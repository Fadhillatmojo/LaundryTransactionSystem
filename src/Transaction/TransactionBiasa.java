...
public class TransactionBiasa extends Transaction{

    public TransactionBiasa(String title, String nama, String tanggal, String jenis, int berat, int jmlJas, int dalaman, int jmlSprei, int jmlBedCover, int diskon, String status, int idTransaction){
        super(title);
    ...
    public void bayar(String nama, String tanggal, String jenis, int berat, int jmlJas, int jmlDalaman, int jmlSprei, int jmlBedCover, int diskon, String status, int idTransaction) {
        ...
        super.getAreaReceipt().setText(super.getAreaReceipt().getText() + "================================================" + "\n");
        super.getAreaReceipt().setText(super.getAreaReceipt().getText() + "  No. Transaksi  : " + idTransaction + "\n");
        super.getAreaReceipt().setText(super.getAreaReceipt().getText() + "================================================" + "\n");
    ...
    public static double generateTotal(int beratLaundry, int jmlJas, int jmlDalaman, int jmlSprei, int jmlBedCover, double jmlDiskon){
        double total = (double) (beratLaundry*5000.0 + jmlJas*30000.0 + jmlDalaman*1000.0 + jmlSprei*5000.0 + jmlBedCover*25000);
