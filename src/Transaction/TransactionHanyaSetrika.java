...
public class TransactionHanyaSetrika extends Transaction{
    private JTextArea areaReceipt;
    private JButton buttonCetakStruk;

    public TransactionHanyaSetrika(String title, String nama, String tanggal, String jenis, int berat, int jmlJas, int dalaman, int jmlSprei, int jmlBedCover, int diskon, String status, int idTransaction){
        super(title);
    ...
    public static double generateTotal(int beratLaundry, int jmlJas, int jmlDalaman, int jmlSprei, int jmlBedCover, double jmlDiskon){
        double total = (double) (beratLaundry*3500.0 + jmlJas*25000.0 + jmlDalaman*500.0 + jmlSprei*3500.0 + jmlBedCover*18000.0);
